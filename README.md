...
The active navitem will change it's color from white to turqouise.
For the desktop view, there is a underline hoover effect added to the navitems, bar *Book Now* button. 
...
•	[FontAwesome](https://fontawesome.com/icons?d=gallery) was used for the icons that I have used on the site;

•	[Google Fonts](https://fonts.google.com/) for adding two font families: Raleway and Allerta Stencil;

•	[jQuery](https://jquery.com/) to reference Javascript needed for the responsive navbar and the *Book Now* modal.

•	[Balsamiq](https://balsamiq.com/) – to create the wireframes.

•	[AdobeXD](https://www.adobe.com/ie/products/xd.html) – to create prototypes of the pages and see how they link together.
